-- Migration: Add organization_id and role columns to users table
...
-- Step 5: Create index on user_organizations
...
-- Step 6: Optional constraint to ensure data integrity (run after adding role column)
...
-- Step 8: Create trigger for user_organizations table
