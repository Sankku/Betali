...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'flex h-11 w-full min-w-0 items-center justify-between rounded-lg',
      ...
      '[&>span]:truncate [&>span]:text-left [&>span]:block [&>span]:min-w-0 [&>span]:flex-1',
      className
    )}
    {...props}
  >
...
>(({ className, children, position = 'popper', ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        'relative z-[100]',
        'max-h-96 min-w-[var(--radix-select-trigger-width)]',
        'overflow-hidden',
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn(
      'px-3 py-2 text-xs font-semibold text-neutral-600 uppercase tracking-wider',
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Separator
    ref={ref}
    className={cn('mx-2 my-1 h-px bg-neutral-300', className)}
    {...props}
  />
));
