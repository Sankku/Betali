export const es = {
  ...
  orders: {
    ...
    view: 'Ver Pedido',
    deleteConfirm: '¿Estás seguro de que deseas eliminar {{count}} pedido(s)?',
    deleteConfirmSingle: '¿Estás seguro de que deseas eliminar este pedido?',
    deleteSuccess: 'Pedido(s) eliminado(s) exitosamente',
    createSuccess: 'Pedido creado exitosamente',
