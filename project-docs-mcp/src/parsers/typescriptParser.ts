...
export class TypeScriptParser {
  ...
  async findAllRoutes(): Promise<string[]> {
  ...
  private parseReactComponent(content: string, filePath: string): ComponentInfo | null {
  ...
  private parseServiceClasses(content: string): string[] {
  ...
  private parseTypeDeclarations(content: string): string[] {
    const types: string[] = [];
  ...
  private parseRouteDefinitions(content: string): string[] {
    const routes: string[] = [];
  ...
  private extractPageRoute(filePath: string): string | null {
